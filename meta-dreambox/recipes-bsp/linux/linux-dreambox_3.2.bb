...
SRC_URI = " \
	...
	${KERNELORG_MIRROR}/linux/kernel/v3.x/patch-${PV}.${PATCHLEVEL}.xz;apply=yes;name=kernel-patch \
	http://download.filesystems.org/unionfs/unionfs-2.x-latest/unionfs-2.6_for_${PV}.62.diff.gz;name=unionfs \
	...
	file://023-it913x-backport-changes-to-${PV}-kernel.patch \
